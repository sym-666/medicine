...
class TGDTA(nn.Module):
    def __init__(self, compound_dim=128, protein_dim=128, gt_layers=10, gt_heads=8, out_dim=1, device=None):
        ...
        self.compound_encoder = gt_net_compound.GraphTransformer(self.device, n_layers=gt_layers, node_dim=44, edge_dim=10, hidden_dim=compound_dim,
